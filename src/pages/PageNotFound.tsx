...
const PageNotFound = () => {
    return (
        ...
        <main className="grid min-h-full place-items-center bg-white px-6 py-60 lg:px-8">
            <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    ...
                    <a href="mailto=kwsbangalore@gmail.com" className="text-sm font-semibold text-gray-900">Contact support <span aria-hidden="true">&rarr;</span></a>
                </div>
            </div>
        </main>
